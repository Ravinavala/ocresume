...
<?php if(pmpro_isLevelRecurring($level)) { ?>
	...
	<?php } else { ?>
		...
		<form id="pmpro_form" class="pmpro_form" action="<?php echo pmpro_url("billing", "", "https")?>" method="post">
			...
			?>
			<table id="pmpro_payment_information_fields" class="pmpro_checkout top1em other_step2" width="100%" cellpadding="0" cellspacing="0" border="0">
			<thead>
				<tr>
					<th>
						<h4><?php _e('Credit Card Information', 'pmpro');?></h4>
