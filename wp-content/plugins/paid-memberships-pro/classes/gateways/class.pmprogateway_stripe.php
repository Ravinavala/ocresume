				...
				<tr valign="top">
					<td>
						...
						<div class="pmpro_payment-account-number">							
                                                        <input id="AccountNumber" placeholder="Card Number*" class="input <?php echo pmpro_getClassForField("AccountNumber");?>" type="text" size="25" value="<?php echo esc_attr($AccountNumber)?>" autocomplete="off" />
						</div>
                                                        </div>
                                                        <div class="col-md-3">
						<div class="pmpro_payment-expiration">							
							<select id="ExpirationMonth"  placeholder= "Expiration Date*" class=" <?php echo pmpro_getClassForField("ExpirationMonth");?>">
								...
								<option value="12" <?php if($ExpirationMonth == "12") { ?>selected="selected"<?php } ?>>12</option>
                                                        ...
                                                        <div class="col-md-3">
                                                        <div>
                                                    <select id="ExpirationYear" class=" <?php echo pmpro_getClassForField("ExpirationYear");?>">
								<?php
						...
						<div class="pmpro_payment-cvv">
                                                    ...
                                                    <input class="input" placeholder="CVV" id="CVV" type="text" size="4" value="<?php if(!empty($_REQUEST['CVV'])) { echo esc_attr($_REQUEST['CVV']); }?>" class=" <?php echo pmpro_getClassForField("CVV");?>" />  <small>(<a href="javascript:void(0);" onclick="javascript:window.open('<?php echo pmpro_https_filter(PMPRO_URL)?>/pages/popup-cvv.html','cvv','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=475');"><?php _e("what's this?", 'pmpro');?></a>)</small>
						</div>
                                                        </div>
						<?php
							}
