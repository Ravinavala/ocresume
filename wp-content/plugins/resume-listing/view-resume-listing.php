...
// LOAD a stylesheet
        ...
        $filename = uniqid(rand(a, z), true) . '.pdf';
        $resume_name = $_SERVER['DOCUMENT_ROOT'] . '/wp-content/uploads/resumes/' . $filename;
    ...
    $uploads = wp_upload_dir();
    $upload_path = $uploads['baseurl'];
    $uploaddir = $upload_path . "/resumes/" . $filename;
}
?>

<form method="post" id="pub_resume" enctype="multipart/form-data" >
    <div  id="loding" class="load_overlay">
    ...
    <div class="side_link">
        <a class="assign dis_a" href="#assign" data-toggle="modal">Assign to</a>
        <a href="<?php echo site_url(); ?>/wp-admin/admin.php?page=mt-top-level-handle-resume-listing">Back</a>
    </div>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
    <div class="workspace reviewer_workspace <?php echo $class; ?>">
                    ...
                    <div class="table">
                        <div class="tbody">
                            ...
                            <div class="tr">
                                ...
                                <div class="td"><span id="review"><?php echo $review_name; ?></span></div>
                            </div>
                            <div class="tr">
        ...
        <div class="workspace_bottom">
            ...
            <div class="submit_btnn workf_form">
                ...
                <?php if ($packageobj->workflow_status != '4') : ?>
                    <a class="red_btn right_btn dis_a">Publish</a>
