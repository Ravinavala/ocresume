...
if (!$_REQUEST['id'] || !$packageobj || $packageobj->workflow_status != '6'):
    ?>
    <script>window.location.href = "<?php echo site_url(); ?>";</script>
<?php endif; ?>
<section class="resume_section reviewer_resume_section	">  
    <div class="container">
        <div class="row">                    
            <div class="col-sm-12"> 
                <h1 class="resume_title entry-title"><?php echo $packageobj->name; ?></h1>
            </div>
        </div>
        <div class="">
            <?php
            ...
            if ($profile_pic):
                ...
                <div class="resume_img">
                    <img src="<?php echo $profile_pic; ?>" class="alignleft"/>
                </div>
                <?php
            else:
            ...
            <div class="<?php echo $profile_calss; ?>">
                <p><?php echo $packageobj->degree; ?></p>
                <p><?php echo $packageobj->school; ?></p>
                <?php if ($packageobj->city): ?>
                    <p><?php echo $packageobj->city; ?></p>
                <?php endif; ?>
                <p>Graduation Date : <?php echo date("d F, Y", strtotime($packageobj->graduation_date)); ?></p>
