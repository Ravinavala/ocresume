            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(".comment_feed1").fadeOut(5000);
                      localStorage.setItem('active', "head");
                    location.reload();
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    console.log(jqXHR + " :: " + textStatus + " :: " + errorThrown);
...
$('#pro_pic').on('click', function (e) {
    ...
    if (width < 100 || height < 100) {
        $(".pic_msg").html('<span class="text-danger pic_msg1 ">Image is small. enter image of minimum 100X100 Dimensions</span>');
        $(".pic_msg1").fadeOut(5000);
        $('#output').attr('src', '');
        $('#output').attr('src', $('#profile_pic').attr('src'));
        $('#loding').hide();
...
$(document).on("click", ".submitpersonalinfo", function (event, parentform, final) {
    ...
    {
        $('a.personal').css('border', '1px solid #39a95e');
        $('a.personal').removeClass("save_err");
        return true;
    } else {
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "skill");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "cource");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "software");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
        ...
        $('a.software').css('border', '1px solid #39a95e');
        $('a.software').removeClass("save_err");
        return true;
    } else {
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "honor");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "activity");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
        ...
        $('a.activity').css('border', '1px solid #39a95e');
        $('a.activity').removeClass("save_err");
        return true;
    } else {
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "interest");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
        ...
        $('a.interest').css('border', '1px solid #39a95e');
        $('a.interest').removeClass("save_err");
        return true;
    } else {
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "references");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
        ...
        $('a.references').css('border', '1px solid #39a95e');
        $('a.references').removeClass("save_err");
        return true;
    } else {
...
$(document).on("click", ".submitstudentprojects", function (event, parentform, final) {
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $('a.project').css('border', '1px solid #39a95e');
        $('a.project').removeClass("save_err");
        return true;
    } else {
    ...
    if (statusflag == 'true' && parentform == undefined) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('active', "work");
                if (final == undefined) {
                    $('#loding').hide();
                    location.reload();
                }
