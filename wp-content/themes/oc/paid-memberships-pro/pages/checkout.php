...
<div id="pmpro_level-<?php echo $pmpro_level->id; ?>">
    ...
    <form id="pmpro_form" class="pmpro_form" action="<?php if (!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
        ...
        <section class="packages_section">
            ...
            <div class="page_title">
                <h1><?php _e('Sign Up', 'pmpro'); ?></h1>
            </div>
            <table id="pmpro_pricing_fields" class="pmpro_checkout checkout_step1" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    -->
            ...
            <?php if (!$skip_account_fields && !$pmpro_review) { ?>
                ...
                <table id="pmpro_user_fields" class="pmpro_checkout other_step2" width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <h4><?php _e('Account Information', 'pmpro'); ?></h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="username" name="username" placeholder="Username*" type="text" class="input <?php echo pmpro_getClassForField("username"); ?>" size="30" value="<?php echo esc_attr($username) ?>" />
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="password" name="password" placeholder="Password*" type="password" class="input <?php echo pmpro_getClassForField("password"); ?>" size="30" value="<?php echo esc_attr($password) ?>" />
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    if ($pmpro_checkout_confirm_password) {
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                ...
                                                <input id="password2" name="password2" placeholder="Confirm Password*" type="password" class="input <?php echo pmpro_getClassForField("password2"); ?>" size="30" value="<?php echo esc_attr($password2) ?>" />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            ...
                                            <input id="bemail" name="bemail" placeholder="E-mail Address*" type="<?php echo ($pmpro_email_field_type ? 'email' : 'text'); ?>" class="input <?php echo pmpro_getClassForField("bemail"); ?>" size="30" value="<?php echo esc_attr($bemail) ?>" />
                                    ...
                                    if ($pmpro_checkout_confirm_email) {
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                ...
                                                <input id="bconfirmemail" name="bconfirmemail" placeholder="Confirm E-mail Address*" type="<?php echo ($pmpro_email_field_type ? 'email' : 'text'); ?>" class="input <?php echo pmpro_getClassForField("bconfirmemail"); ?>" size="30" value="<?php echo esc_attr($bconfirmemail) ?>" />
            ...
            <?php if (pmpro_getGateway() == "paypal" && empty($pmpro_review)) { ?>
                ...
                <table id="pmpro_payment_method" class="pmpro_checkout top1em other_step2" width="100%" cellpadding="0" cellspacing="0" border="0" <?php if (!$pmpro_requirebilling) { ?>style="display: none;"<?php } ?>>
                    <thead>
                        <tr>
            ...
            if ($pmpro_include_billing_address_fields) {
                ...
                <table id="pmpro_billing_address_fields" class="<?php if ($current_user->ID) echo "disable_add"; ?> pmpro_checkout top1em other_step2" width="100%" cellpadding="0" cellspacing="0" border="0" <?php if (!$pmpro_requirebilling || apply_filters("pmpro_hide_billing_address_fields", false)) { ?>style="display: none;"<?php } ?>>

                    <thead>

                        <tr>

                            <th><h4><?php _e('Billing Address', 'pmpro'); ?></h4></th>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="bfirstname" name="bfirstname" placeholder="First Name*" type="text" class="input <?php echo pmpro_getClassForField("bfirstname"); ?>" size="30" value="<?php echo esc_attr($bfirstname) ?>" />
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="blastname" name="blastname" placeholder="Last Name*" type="text" class="input <?php echo pmpro_getClassForField("blastname"); ?>" size="30" value="<?php echo esc_attr($blastname) ?>" />
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="baddress1" name="baddress1" placeholder="Address 1*" type="text" class="input <?php echo pmpro_getClassForField("baddress1"); ?>" size="30" value="<?php echo esc_attr($baddress1) ?>" />
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="baddress2" name="baddress2" placeholder="Address 2*" type="text" class="input <?php echo pmpro_getClassForField("baddress2"); ?>" size="30" value="<?php echo esc_attr($baddress2) ?>" />
                                    ...
                                    if ($longform_address) {
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                ...
                                                <input id="bcity" name="bcity" placeholder="City*" type="text" class="input <?php echo pmpro_getClassForField("bcity"); ?>" size="30" value="<?php echo esc_attr($bcity) ?>" />
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                ...
                                                <input id="bstate" name="bstate" placeholder="State*" type="text" class="input <?php echo pmpro_getClassForField("bstate"); ?>" size="30" value="<?php echo esc_attr($bstate) ?>" />

                                            </div></div>
                                        <div class="col-md-6">
                                            <div>

                                                <input id="bzipcode" name="bzipcode" placeholder="Postal Code*" type="text" class="input <?php echo pmpro_getClassForField("bzipcode"); ?>" size="30" value="<?php echo esc_attr($bzipcode) ?>" />
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                ...
                                                <input id="bcity" name="bcity" placeholder="" type="text" class="input <?php echo pmpro_getClassForField("bcity"); ?>" size="14" value="<?php echo esc_attr($bcity) ?>" />,
                                    ...
                                    if ($show_country) {
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                ...
                                                <select name="bcountry"  placeholder="Country" class=" <?php echo pmpro_getClassForField("bcountry"); ?>">
                                                    <?php
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input id="bphone" name="bphone" placeholder="Phone*" type="text" class="input <?php echo pmpro_getClassForField("bphone"); ?>" size="30" value="<?php echo esc_attr(formatPhone($bphone)) ?>" />
            ...
            if ($pmpro_include_payment_information_fields) {
                ...
                <table id="pmpro_payment_information_fields" class="pmpro_checkout top1em other_step2" width="100%" cellpadding="0" cellspacing="0" border="0" <?php if (!$pmpro_requirebilling || apply_filters("pmpro_hide_payment_information_fields", false)) { ?>style="display: none;"<?php } ?>>
...
<!--
                ...
                //add required to requiredfields
